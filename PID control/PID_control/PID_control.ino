    ...
    if (startFlag == 1)
    {
      ...
      if (preTime != 0)
      {
        ...
        */
        ...
        errorRoll= errorRoll*pidGain[0]-(preHDRX/ gyroScale);
        iRoll += ((errorRoll)*gapTime);
        d = ((errorRoll - preErrorRoll)/gapTime);
        ...
        errorPitch=errorPitch*pidGain[0]-(preHDRY/gyroScale);
        iPitch += ((errorPitch)*gapTime);
        d = ((errorPitch - preErrorPitch)/gapTime);
